...
<head>
  ...
  <!-- Site Metas -->
  <meta name="keywords" content="Hershey's, chocolates, milk chocolate, chocolate bars" />
  <meta name="description" content="Discover the classic Hershey's chocolates collection at ChocoLux" />
  <meta name="author" content="" />

  <title>Hershey's - ChocoLux</title>
...
<body class="sub_page">
  ...
  <div class="dropdown-menu" aria-labelledby="shopDropdown" style="color: black;">
    ...
    <section class="product-hero">
      <div class="container">
        <!-- <h1 data-aos="fade-up">Hershey's</h1> -->
        <!-- <p data-aos="fade-up" data-aos-delay="200">Discover our classic collection of Hershey's chocolates, a timeless American favorite with rich, creamy milk chocolate.</p> -->
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
            <div class="product-image">
             <img src="uploads/1745592062118_Hersheys.png" alt="Hershey's" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-6" data-aos="fade-left">
            <div class="product-info">
              <h2>Hershey's Milk Chocolate</h2>
              <div class="product-price">&#8377;70.0</div>
              ...
              <div class="product-meta">
                <p><span>Brand:</span> Hershey's</p>
                <p><span>Category:</span> Milk Chocolate</p>
                <p><span>Weight:</span> 40g</p>
    ...
    <section class="related-products">
      <div class="container">
        <div class="heading_container" data-aos="fade-up">
          ...
          <p>
            Discover our other classic Hershey's chocolate collections
          </p>
        </div>
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/Hershey's_KISSES_Chocolate_.jpg" alt="Hershey's Kisses">
              </div>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/Hershey's-cream.jpg" alt="Hershey's Cookies 'n' Creme">
              </div>
              <div class="related-product-info">
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/Hershey's-Dark.jpeg" alt="Hershey's Special Dark">
              </div>
              <div class="related-product-info">
        ...
        $(document).ready(function() {
            $('.add-to-cart-btn').click(function() {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        pid: 3, // Correct PID for Hershey's
                        quantity: quantity
                    },
