...
<head>
  ...
  <style>
    ...
    .product-hero {
      background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('images/kitkat-banner.jpg');
      height: 400px;
      display: flex;
      align-items: center;
...
<body class="sub_page">
  ...
  <div class="dropdown-menu" aria-labelledby="shopDropdown" style="color: black;">
    ...
    <section class="product-hero">
      <div class="container">
        <!-- <h1 data-aos="fade-up">KitKat</h1> -->
        <!-- <p data-aos="fade-up" data-aos-delay="200">Discover our premium collection of KitKat chocolates, the iconic wafer and chocolate treat that's perfect for sharing.</p> -->
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
            <div class="product-image">
              <img src="images/kitkat.png" alt="KitKat" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-6" data-aos="fade-left">
            <div class="product-info">
              ...
              <div class="product-description">
                <p>Experience the perfect combination of crispy wafer and smooth milk chocolate with KitKat. Each finger-sized bar is designed to be snapped and shared, making it the perfect treat for any occasion.</p>
                <p>With its distinctive red packaging and the famous "Have a Break, Have a KitKat" slogan, KitKat has become one of the world's most recognizable chocolate brands.</p>
              </div>
              ...
              <div class="product-meta">
                <p><span>Brand:</span> Nestlé</p>
                <p><span>Category:</span> Wafer and Milk Chocolate</p>
    ...
    <section class="related-products">
      <div class="container">
        <div class="heading_container" data-aos="fade-up">
          <h2>
            More KitKat Products
          </h2>
          <p>
            Discover our other premium KitKat chocolate collections
          </p>
        </div>
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/nestles-vegan-kitkat-uk-1024x576-removebg-preview.png" alt="KitKat Vegan">
              </div>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/chunky.jpeg" alt="KitKat Chunky">
              </div>
              <div class="related-product-info">
                <h4>KitKat Chunky</h4>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/festive-nestle-kitkat-gift-hamper_1.jpg" alt="KitKat Gift Box">
              </div>
              <div class="related-product-info">
                <h4>KitKat Gift Box</h4>
                <div class="related-product-price">&#8377;180</div>
                <a href="#" class="view-product-btn">View Product</a>
              </div>
            </div>
          </div>
