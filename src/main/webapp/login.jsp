    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if (email != null && password != null && !email.isEmpty() && !password.isEmpty()) {
            ...
            try {
                ...
                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/chocolate", "root", "rootroot");
...
<head>
    ...
    <style>
        .auth-container {
            ...
            padding: 20px;
            overflow: hidden;
            background: url('images/WhatsApp Image 2025-04-15 at 10.06.57.jpeg') center/cover no-repeat fixed;
        }
    ...
    <div class="auth-container">
       ...
       <!--  <div class="video-error">
        ...
        <div class="auth-card">
            ...
            <h2>Welcome Back</h2>
            <% if (!message.isEmpty()) { %>
                <div style="color: #ffdddd; background-color: #772e2e; padding: 10px; border-radius: 8px; text-align: center; margin-bottom: 15px;">
                    <%= message %>
                </div>
            <% } %>
            <form method="post">
