...
<head>
  ...
  <!-- Site Metas -->
  <meta name="keywords" content="Ferrero Rocher, chocolates, luxury chocolates, hazelnut chocolates" />
  <meta name="description" content="Discover the premium Ferrero Rocher chocolates collection at ChocoLux" />
  <meta name="author" content="" />

  <title>Ferrero Rocher - ChocoLux</title>
  ...
  <style>
    ...
    .product-hero {
      background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('images/Ferrero-Rocher-banner2.jpg');
...
<body class="sub_page">
  ...
  <div class="dropdown-menu" aria-labelledby="shopDropdown" style="color: black;">
    ...
    <section class="product-hero">
      <div class="container">
        <h1 data-aos="fade-up">Ferrero Rocher</h1>
        <p data-aos="fade-up" data-aos-delay="200">Discover our premium collection of Ferrero Rocher chocolates, crafted with the finest ingredients for an unforgettable taste experience.</p>
      </div>
    </section>
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <div class="product-info">
              ...
              <div class="product-description">
                <p>Experience the perfect blend of a whole roasted hazelnut, surrounded by a delicate wafer shell filled with hazelnut cream, and covered in milk chocolate and chopped hazelnuts. Ferrero Rocher offers a unique taste and texture that delights the senses.</p>
                <p>Each piece is individually wrapped in gold foil and placed in a transparent box, making it an elegant gift for any occasion.</p>
              </div>
    ...
    <section class="related-products">
      <div class="container">
        <div class="heading_container" data-aos="fade-up">
          <h2>
            More Ferrero Products
          </h2>
          <p>
            Discover our other premium Ferrero chocolate collections
          </p>
        </div>
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/Tronky.jpg" alt="Ferrero Tronky">
              </div>
              <div class="related-product-info">
                <h4>Ferrero Tronky</h4>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/Ferrero-Rondnoir.jpg" alt="Ferrero Rocher Cake">
              </div>
              <div class="related-product-info">
                <h4>Ferrero Rondnoir</h4>
                <div class="related-product-price">&#8377;220.0</div>
                <a href="#" class="view-product-btn">View Product</a>
              </div>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="related-product-card">
              <div class="related-product-img">
                <img src="images/ferrero-raffaello.jpg" alt="Ferrero Collection">
              </div>
              <div class="related-product-info">
                <h4>Ferrero Raffaello</h4>
                <div class="related-product-price">&#8377;240.0</div>
                <a href="#" class="view-product-btn">View Product</a>
              </div>
            </div>
          </div>
